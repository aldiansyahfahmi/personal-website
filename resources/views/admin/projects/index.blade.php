        ...
        <tbody class="divide-y divide-primary/5">
            ...
            <tr class="hover:bg-primary/5 transition-colors">
                <td class="px-6 py-4 text-white">
                    <img src="{{ Str::startsWith($project->image, 'http') ? $project->image : asset('storage/public/' . $project->image) }}" class="w-20 h-12 object-cover rounded-lg bg-black/50 border border-primary/10">
                </td>
