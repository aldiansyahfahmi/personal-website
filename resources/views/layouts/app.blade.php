...
<body class="antialiased min-h-screen flex flex-col relative">
    ...
    <!-- Background -->
    <div class="fixed inset-0 pointer-events-none bg-dark z-[-1]"></div>
    ...
    <!-- Main Content -->
    <main class="flex-grow pt-20 z-10">
        @yield('content')
    </main>

    <!-- Footer -->
    <footer class="bg-black/50 backdrop-blur-sm py-6 mt-12 z-10 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-gray-400 text-sm mb-4 md:mb-0">
                    Designed and Developed by Aldiansyah Fahmi.
                </div>
                <div class="flex space-x-6">
                     <!-- LinkedIn -->
                     <a href="https://www.linkedin.com/in/aldiansyah99/" target="_blank" class="text-gray-400 hover:text-primary transition-colors">
                        <span class="sr-only">LinkedIn</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/aldiansyahf99/?hl=id" target="_blank" class="text-gray-400 hover:text-primary transition-colors">
                    ...
                    <!-- GitHub -->
                    <a href="https://github.com/aldiansyahfahmi" target="_blank" class="text-gray-400 hover:text-primary transition-colors">
