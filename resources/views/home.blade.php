    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 z-10">
                <h2 class="text-4xl text-gray-100 font-medium">Hello There! <span class="animate-pulse">👋🏻</span></h2>
                <h1 class="text-6xl md:text-7xl font-bold text-white tracking-tight">
                    I'M <span class="text-primary">ALDIANSYAH FAHMI</span>
                </h1>
                
                <div class="text-3xl md:text-4xl text-primary font-bold min-h-[60px] flex items-center">
                    <span id="typewriter-text" class="border-r-4 border-primary pr-2 animate-pulse"></span>
                </div>

                <div class="pt-8">
                     <!-- Social Buttons usually go here -->
                </div>
            </div>
